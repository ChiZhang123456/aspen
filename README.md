...
Ionization uses a sampled-event estimator. In an altitude bin, many particles
may pass through or collide elastically, but only sampled collision events with
