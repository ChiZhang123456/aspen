"""Neutral atmosphere model used by py_aspen.
...
All packaged data are stored in `py_aspen/neutral_density_model/data` as `.mat`
...
```python
from py_aspen.neutral_density_model.gitm import gitm_density
from py_aspen.neutral_density_model.amps import amps_density
